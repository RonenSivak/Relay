...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    **1. Automated key check** — For each `t('key')` you added, verify the key exists in the key subset provided above. If a key is NOT in the subset, you hallucinated it — revert that replacement to the original string immediately.
